...
const EachOtherProjects = ({
  ...
  return (
    <div className={`${styles.EachOtherProjects} lg:max-w-[32%] max-w-full flex flex-col space-y-4 p-6 bg-primary_bg2 shadow-lg rounded-lg h-80 relative bottom-0 hover:bottom-2`}>
