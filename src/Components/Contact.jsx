...
const Contact = () => {
  ...
  return (
    <div className={styles.contactW} id='contact'>
        ...
        <h1 className='text-[2rem] font-bold text-var_color' data-aos='fade-down'>Get In Touch</h1>
        <p className='lg:w-[60%] text-center' data-aos='flip-up'>{"I am excited about the potential of working together to create stunning web experiences that not only meet but exceed expectations. If you would be interested in exploring a collaboration or discussing potential projects, I would be thrilled to set up a time to chat. Please let me know if you would like to schedule a call or if there's any other way I can provide additional information. Thank you🥰😍"}</p>
       <a href="https://api.whatsapp.com/send?phone=2349135619423&text=Hello%20I%20will%20like%20to%20Hire%20You" target='_blank' data-aos='fade-up'><p className={styles.sayHello}></p></a>
