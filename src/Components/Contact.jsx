...
const Contact = () => {
  ...
  return (
    <div className={styles.contactW} id='contact'>
       ...
       <a href="https://api.whatsapp.com/send?phone=2349135619423&text=Hello%20I%20will%20like%20to%20Hire%20You" target='_blank' rel="noopener noreferrer"><p className={styles.sayHello}></p></a>
